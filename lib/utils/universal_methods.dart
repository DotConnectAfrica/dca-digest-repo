...
class UniversalMethods {
  ...
  Future  show_DualBTN_Dialog(BuildContext context, title, message,action,action2) async {
    return showDialog (
      context: context,
  ...
  Future  show_Ok_Dialog(BuildContext context, title, message,action) async {
    return showDialog (
      context: context,
      barrierDismissible: false, // user must tap button!
      builder: (BuildContext context) {
...
class MyColors {
  Color primaryColor=Color.fromRGBO(249, 98, 158,1.0);
}
